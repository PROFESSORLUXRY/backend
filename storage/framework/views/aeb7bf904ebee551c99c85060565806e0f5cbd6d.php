<?php $__env->startSection('content'); ?>
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid flex-grow-1 container-p-y">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('cookie_settings.download')); ?>" method="POST">
                        <div class="mb-3">
    ...
    <script>
        const url = '<?php echo e(route('cookie_settings.items')); ?>'
            ...
            buttons: [
                {
                    ...
                    action: function () {
                        window.location = '<?php echo e(route('cookie_settings.create')); ?>'
                    }
                }
            ],
        })
...
<?php echo $__env->make('pages.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\friezer-backend\resources\views/pages/cookie_settings/index.blade.php ENDPATH**/ ?>