...
<?php $__env->startSection('content'); ?>
    ...
    <script>
        const url = '<?php echo e(route('clipper.items')); ?>'
            ...
            buttons: [
                {
                    ...
                    action: function () {
                        window.location = '<?php echo e(route('clipper.create')); ?>'
                    }
                }
            ],
        })
...
<?php echo $__env->make('pages.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\friezer-backend\resources\views/pages/clipper/index.blade.php ENDPATH**/ ?>